/*
 (c) Copyright 2005-2023 PaperCut Software Pty Ltd
 */
...
namespace PaperCut
{
    ...
    public interface IServerCommandProxy : IXmlRpcProxy
    {
        ...
        [XmlRpcMethod("api.batchImportUsers")]
        void BatchImportUsers(string authToken, string importFile, bool createNewUsers, bool emailUsersOnCreation);
        ...
        [XmlRpcMethod("api.batchImportInternalUsers")]
        void BatchImportInternalUsers(string authToken, string importFile, bool overwriteExistingPasswords,
                                      bool overwriteExistingPINs, bool emailUserOnCreation);
        ...
        [XmlRpcMethod("api.batchImportPrinters")]
        void BatchImportPrinters(string authToken, string importFile);
    ...
    public class ServerCommandProxy
    {
        ...
        /// </returns>
        public string GetUserOverdraftMode(string username)
        {
        ...
        /// </param>
        public void SetUserOverdraftMode(string username, string mode)
        {
        ...
        /// </returns>
        public string GetSharedAccountOverdraftMode(string sharedAccountName)
        {
        ...
        /// </param>
        public void SetSharedAccountOverdraftMode(string sharedAccountName, string mode)
        {
        ...
        /// </returns>
        public string[] GetPrinterProperties(string serverName, string printerName, string[] propertyNames)
        {
        ...
        /// </param>
        public void SetPrinterProperties(string serverName, string printerName, string[,] propertyNamesAndValues)
        {
            _proxy.SetPrinterProperties(_authToken, serverName, printerName, propertyNamesAndValues);
        }


        public bool ApplyDeviceSettings(string deviceName)
        {
        ...
        public GetTaskStatusResponse GetTaskStatus()
        {
        ...
        ///  True to overwrite existing user PINs, false to only update un-set PINs.
        /// </param>
        /// <param name="emailUserOnCreation">
        ///  True to email users upon their creation.
        /// </param>
        ///
        public void BatchImportInternalUsers(string importFile, bool overwriteExistingPasswords,
                                             bool overwriteExistingPINs, bool emailUserOnCreation)
        {
            _proxy.BatchImportInternalUsers(_authToken, importFile, overwriteExistingPasswords, overwriteExistingPINs, emailUserOnCreation);
        }
        ...
        {
            _proxy.BatchImportPrinters(_authToken, importFile);
        }
